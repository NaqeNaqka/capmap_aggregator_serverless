...
#if running locally, dont connect to storage service
try:
...
try:
    ...
    # Pass the parsed dates to the aggregate.main function
    main(parsed_start_date, parsed_end_date, LOCAL)

except:
    logger.info("Failed getting aggregation dates, using defaults.")
